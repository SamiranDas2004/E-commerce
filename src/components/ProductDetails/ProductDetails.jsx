...
const handelClick =()=>{
  ...
  return (
            ...
            <div className="mt-4 lg:row-span-3 lg:mt-0">
              ...
              <div className="mt-6">
                <div className="flex items-center">
                  ...
                  <p className=" opacity-50 text-sm">5660</p>
    ...
    reviews and ratings*/}
        ...
        <section>
          <h1 className="font-semibold text-lg pb-4">Review's And Ratings</h1>
            ...
            <Grid container spacing={7}>
              ...
              <Grid item xs={5}>
                ...
                <div>
                  ...
                  <p className=" opacity-60">5748 Ratings</p>
                </div>
